...
- Pendiente de confirmación manual por el desarrollador en el dispositivo físico (Tab A9+ real); esta corrección se verificó con Playwright contra datos reales en local, pero no contra el sitio desplegado en producción todavía.
